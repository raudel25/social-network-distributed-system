...
var file_pkg_services_proto_db_models_proto_goTypes = []any{
...
func file_pkg_services_proto_db_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_services_proto_db_models_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_services_proto_db_models_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_services_proto_db_models_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_services_proto_db_models_proto_msgTypes[3].Exporter = func(v any, i int) any {
